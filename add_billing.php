...
?>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Add Bill <small><?php echo $patient ?></small></h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                ...
                <label class="col-md-1 control-label">Date</label>
                  ...
                  <div class="col-md-2">
                  	<input class="form-control add_falseedit"   required="required" name="date" value="<?php echo $bill['date'] ?>"/>
                  </div>
                ...
                <div class="form-group">
                 <div class="col-md-1">
                      <button class="btn btn-block btn-primary  addbillplus " ><i class="fa fa-plus"></i></button>
                  </div>
                  <div class="col-md-4">
				  ...
				  foreach ($billservs as $serv){
					  ...
					  print	'</select>
							  ...
							  <div class="col-md-2">
								<input class="form-control add_falseedit" placeholder="0.00" dir="rtl"  value="'.$amount.'" 
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-offset-1 col-md-2">
                    <button type="submit" class="btn btn-block btn-primary " name="submit" value="submit" >Add Bill</button>
                  </div>
                  <div class="col-md-2">
