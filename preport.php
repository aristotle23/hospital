...
$ttlbills = $db->getOne("select count(*) as ttl from billing where date between ? and ? order by date desc ",
...
$reportClass = new preport($_REQUEST['from'],$_REQUEST['to'],$offset,$rowperpage); //generate report for this date
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered preport-table" >
                                    <thead>
                                        <tr>
                                            <th width="18%">DATE</th>
                                            <th>CARD NO</th>
