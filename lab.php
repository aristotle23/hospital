...
if(isset($_REQUEST['submit']) && $_REQUEST['submit'] == 'save' && $_REQUEST['pid']){
	...
	for($i = 0 ; $i < count($ids) ; $i++){
		...
		$db->execute("update diagnosis set alert = 2 where id = ? and alert = 1",array($id));
...
?>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <?php
				$result = $db->getAll("select diagnose, id from diagnosis where patient_id = ? and date = ? and payment = 0 and lab = 1 and services_id is null",
				...
				foreach($result as $diag){
                  ...
                  <textarea rows="2" name="result[]" class="form-control" placeholder="Result"></textarea>
