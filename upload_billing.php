...
$patientid = $db->executeGetId("INSERT INTO `hmo` (`date`, `hospital_id`, `name`, `address`, `phone`,`email`) VALUES (?, ?, ?, ?, ?, ?)",
								array($date,$hospital_id,$name,$address,$phone,$email));
  if($patientid){
...
?>
        <div id="page-wrapper" >
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Upload Billing</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <form role="form" class="form-horizontal" action="<?php echo $_SERVER['PHP_SELF'] ?>" enctype="multipart/form-data" method="post">
                <div class="row ">
                    ...
                    <div class="col-md-3">
                    	 <input class="form-control " type="text" name="hospital_id" required="required" >
                    </div>
                    </div>
                    <div class="form-group" >
