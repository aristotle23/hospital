                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody id="ptblbody">
								<?php
                                    $results = $db->getAll("select * from income");
                                    foreach($results as $key=>$result){
										...
										$btn =	"<a class='btn btn-default delete' style='".$dis."' data-table='income' 
                                                data-id='".$result['id']."'>Del</a>";
										if($_SESSION['right'] > 2) {
                                            print "<a class='btn btn-primary btn-primary ' href='add_income.php?edit=" . $result['id'] . "'>Edit</a> ";
                                        }
										$dis = ($result['hide'] == 0) ? "display: none":"";
										$btn .= "<a class='btn btn-link delundo' style='".$dis."' data-table='income' 
